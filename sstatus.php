                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $i=1;
                            $query = "SELECT * FROM sapplydb WHERE Student_ID='".$_SESSION['Student_ID']."' order by ID DESC";
                                ...
                                foreach($query_run as $student)
                                {
                                    ...
                                    <tr>
                                        ...
                                        if($student['Status']=="Approved"){
                                            ...
                                            ?>
                                        <td><button type="submit" name="Approve" class="btn btn-block btn-primary" value="<?php echo $student['ID']; ?>" style="background:Green; color:black;"><?= $student['Status'] ?></button></td>
                                         <?php
                                        }elseif($student['Status']=="Reject"){
                                            $_SESSION['ID']=$student['ID'];
                                         ?>
                                         <td><button type="submit" name="Reject" class="btn btn-block btn-primary" value="<?php echo $student['ID']; ?>" style="background:red; color:black;"><?= $student['Status'] ?></button></td>
                                         <?php
                                    ...
                                    <button type="button" value="<?=$student['ID'];?>" class="viewStudentBtn btn btn-info btn-sm">View</button>
                                        ...
                                        if($student['Status']=="Approved"){
                                            $_SESSION['ID']=$student['ID'];
                                            ?>
                                            <form action="sreceipt.php" method="post">
                                        <td><button type="submit" name="Approve" class="btn btn-block btn-primary" value="<?php echo $student['ID']; ?>" style="background:Green;">Print</button></td>
                                        </form>
                                         <?php
                                        }elseif($student['Status']=="Reject"){
                                            $_SESSION['ID']=$student['ID'];
                                         ?>
                                         <form action="sappeal.php" method="post">
                                
                                         <td> <a href="sappeal.php?id=<?= $student['ID'] ?>" class="btn btn-block btn-primary" style="background:red;">Appeal</a></td>
                                         </form>
                                         <?php
                                        }elseif($student['Status']=="Pending"){
                                            $_SESSION['ID']=$student['ID'];
