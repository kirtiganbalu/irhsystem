...
if(mysqli_num_rows($result)>0){
    ...
    elseif($Pphone != $_SESSION['parent_num']){
        ...
        $query="UPDATE sapplydb set Name=' $name',IC_number='$IC',Reg_number='$Reg',Check_out='$Check_Out',Check_in='$Check_In',Gender='$gender',Block='$block',Warden_ID='$warden',Room_num='$roomno',Phone_num='$sphone',Parent_number='$Pphone',Transport_detail='$Transportation',Destination_add='$dAddress',Reason='$Reason',Student_ID='$Student_ID',Status='$Status',Comment='$Comment' WHERE ID='$ID'";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/sappeal.css">
...
<form action="#" method="post">
    ...
    {
    $sapply_id=$_GET['id'];
    $query = "SELECT * FROM sapplydb WHERE ID='$sapply_id'";
    $query_run = mysqli_query($conn, $query);

    if(mysqli_num_rows($query_run) > 0)
    {
        $sapply_id=mysqli_fetch_array($query_run);
    ?>
        <input type="hidden" name="Student_ID" value="<?php echo $_SESSION['Student_ID']; ?>">
        <input type="hidden" name="sroom_type" value="<?php echo $_SESSION['sroom_type']; ?>">
        <input type="hidden" name=ID1 value="<?php echo $sapply_id=$_GET['id']; ?>">
        <div class="input-box">
            <span class="details">Name<a class="error">*</a></span>
            <input type="text" value="<?php echo $_SESSION['name'];?>" Name="Name1" id="Name1" style="text-transform:uppercase;" required>
        ...
        <div class="input-box">
            ...
            <div class="custom_select" id="poll2" name="warden">
