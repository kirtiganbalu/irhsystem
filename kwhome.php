...
<html>
	<head>
        ...
        <title>Ketua Warden HomePage</title>
    ...
    <input type="hidden" name="warden_id" value="<?php echo $_SESSION['Warden_ID']; ?>">
        ...
        <?php
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $warden)
                                {
                                    ...
                                    ?>
        <img src="img/<?php echo $warden['camera']; ?>"  class="user-pic" style="width:100px; border-radius:30%; cursor:pointer; margin-right:1px;">
            <?php
                                }}
            ?>
      ...
      <div class="time">
        ...
        <span id="period">AM</span>
            ...
            <li class="item"><a href="kwupdatetask.php">UPDATE TASK</a></li>
            <li class="item"><a href="kw_wardenlist.php">WARDEN LIST</a></li>
            <li class="item"><a href="kw_studentlist.php">STUDENT LIST</a></li>
            <li class="item"><a href="kw_irhslist.php">iRHS LIST</a></li>
            <li class="item"><a href="main_admin_setup_updatestd.php">KEMASKINI IRHS</a></li>
            <li class="item button"><a href="kwprofile.php">Profile</a></li>
            <li class="item button secondary"><a href="wlogoutdb.php">Log Out</a></li>
