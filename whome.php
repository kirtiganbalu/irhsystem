    ...
    <input type="hidden" name="warden_id" value="<?php echo $_SESSION['Warden_ID']; ?>">
        ...
        <?php
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $warden)
                                {
                                    ...
                                    ?>
        <img src="img/<?php echo $warden['camera']; ?>"  class="user-pic" style="width:100px; border-radius:30%; cursor:pointer; margin-right:80px;">
            <?php
                                }}
            ?>
      ...
      <div class="time">
        ...
        <span id="period">AM</span>
            ...
            <li class="item"><a href="wrequest.php">STUDENTS REQUEST</a></li>
            <li class="item"><a href="whistory.php">IRHS HISTORY</a></li>
            <li class="item"><a href="wcontact_info.php">CONTACT INFO</a></li>
            <li class="item button"><a href="wprofile.php">Profile</a></li>
