...
if(isset($_POST['update_profile'])){
  ...
  $Warden_ID=($_POST['Warden_ID']);
         $query="UPDATE signup_warden set Name='$name',id_num='$idnumber',phone_num='$phonenum',email='$email',gender='$gender',user_type='$user_type',block='$block',Room_Type='$room_type' WHERE Warden_ID='$Warden_ID'";
...
<input type="hidden" name="user_type" value="<?php echo $_SESSION['user_type']; ?>">
      ...
      <span>username :</span>
         ...
         <span>Room_Type</span>
              ...
              <span>Block :</span>
                ...
                <a href="kwnewpassword.php" class="delete-btn" style="text-decoration: none; background-color:cadetblue; color:black;">Reset Password</a> 
      ...
      <a href="kwhome.php" class="delete-btn" style="text-decoration: none; color:black;">go back</a>
   </form>
                        </form>
